        ...
        public HrpData()
        {
            bahceModels = new List<BahceModel>()
            {
                new BahceModel()
                {
                    ...
                    Renk="Dorée, Bronze, Noir, Naturel ",
                    YuzeyTipi="Satin, Vernis ",
                    TemizlikveBakim="Produits d’entretien HRP-F",
            ...
            icMekanModels = new List<icMekanModel>()
            {
                new icMekanModel()
                {
                    ...
                    Malzeme="AISI 304 / AISI 316 (EN 1,4301, EN 1,4401)",
                    Renk="Dorée, Bronze, Noir, Naturel ",
                    AhsapKaplama=" Bois Moiré, Bois De Rose Brésilien, Ébène Brun, Chêne Épais, Chêne Extra, Platine",
                    YuzeyTipi=" Satin, Vernis ",
                    TemizlikveBakim="Produits d’entretien HRP-F ",
                    Images= new List<Images>()
                    {
            ...
            aydinlatmaModels = new List<AydinlatmaModel>()
            {
                new AydinlatmaModel
                {
                    ...
                    Yukseklik="5000 mm",
                    Malzeme="AISI 304 / AISI 316 (EN 1,4301, EN 1,4401)",
                    Renk=" Bronze, Noir, Naturel ",
                    Yuzeytipi="Satin, Vernis ",
                    EkMalzeme="Éclairage IP65 ",
                    TemizlikveBakim="Produits d’entretien HRP-F ",
                    Images= new List<Images>()
                    {
